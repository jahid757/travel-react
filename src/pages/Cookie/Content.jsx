...
const Content = () => {
        ...
        <div className="breadcrumb-outer">
            <div className="container">
                <div className="breadcrumb-content text-center">
                    <h1 className="mb-3">Our Cookie policy</h1>
                    <nav aria-label="breadcrumb" className="d-block">
                        <ul className="breadcrumb">
                            <li className="breadcrumb-item"><Link to="/">Home</Link></li>
                            <li className="breadcrumb-item active" aria-current="page">Cookie</li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <section className="our-team pb-6">
        <div className="container">
            ...
            <div className="single_desc">
                <p className="heading">Types of cookies</p>
            ...
            <div className="single_desc">
                <p className="heading">Analytics Tools</p>
            ...
            <div className="single_desc">
                <p className="heading">Controlling cookies</p>
            ...
            <div className="single_desc">
                <p className="heading">Changes to the policy</p>
